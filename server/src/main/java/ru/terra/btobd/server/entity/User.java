 ...
 */
@Entity
@Table(name = "users", catalog = "obd", schema = "", uniqueConstraints = {@UniqueConstraint(columnNames = {"login"})})
@XmlRootElement
...
public class User extends AbstractUser implements Serializable {
    ...
    public List<OBDInfo> getInfoList() {
        return infoList;
    }

    public void setInfoList(List<OBDInfo> infoList) {
